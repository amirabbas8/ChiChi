...
public class PullToUpdateListView extends ListView implements OnScrollListener {
    ...
    public boolean onTouchEvent(@NonNull MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_MOVE:
                if ((getFirstVisiblePosition() == 0) && (pullState == RELEASE || pullState == DOING_NOTHING)) {
                    ...
                    if (getFirstVisiblePosition() == 0
                        ...
                        String PULL_MESSAGE = "Pull to refresh.";
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (getFirstVisiblePosition() == 0 && mHeaderView.getBottom() >= (headerFixedOriginalHeight * releaseTrigger / 2)) {
                    Log.d("FRED", "LOADING");
                    pullState = LOADING;
     ...
     * Set mode
     *
     * @param mode MODE.UP_ONLY -> Only up pull active MODE.UP_AND_DOWN -> Up and
     *             down pull active
     */
     ...
     *
     * @param autoload
     * @param autoLoadDistanceToEnd distance to end of list
     */
